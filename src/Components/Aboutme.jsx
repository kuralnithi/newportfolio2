        ...
        <div>
            ...
            <div className="container-fluid about-container aboutpage">
                ...
                <div className="download-button-container">
                    <a href='https://drive.google.com/file/d/1jHgBp2eYD6IYjZlGlsPI9yyyKhtLdS_I/view?usp=sharing' class="btn btn-download" data-cursor-magnetic data-cursor-color="#61dbfb">Download Resume</a>
                </div>
